  ...
  return (
    <div>
      ...
      <section className="relative bg-accent text-white py-20 sm:py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          {homepage?.heroSubheadline && (
            <p className="text-lg sm:text-xl font-semibold text-white mb-10 max-w-2xl mx-auto leading-relaxed">
              {homepage.heroSubheadline}
            </p>
          )}
      ...
      {settings?.missionBarText && (
        <section className="bg-accent py-10 sm:py-12 md:py-14 px-6 md:px-12">
